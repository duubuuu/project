...
include_once(G5_THEME_PATH.'/menum.php');
...
add_javascript('<script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>');
...
add_stylesheet('<link href="https://fonts.googleapis.com/css?family=Noto+Sans:400,400i,700,700i&display=swap" rel="stylesheet">');
...
<div id="right-side">
  <div class="quick_menu">
    ...
    <nav class="side_gnb">
        <div class="call"><a href="tel:1566-3469"><li><i class="xi-call xi-fw"></i>민재산업 전화걸기</li></a></div>
        <ul class="menu-list">
...
<div id="header_wrap">
    <header id="header">
        <div class="header-inner">
            <div id="logo"><a href="/"><img src="<?=G5_THEME_URL?>/img/logo.png"></a></div>
            <ul class="gnb">
                <?php foreach($MENUM as $k=>$l_menu) { ?>
                <li class="lm">
            ...
            <?php }  ?>
            <li class="login"><a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=<?php echo G5_BBS_URL ?>/register_form.php"><i class="xi-wrench"></i> 정보수정</a></li>
