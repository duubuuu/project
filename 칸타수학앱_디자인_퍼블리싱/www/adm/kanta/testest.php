  ...
  <div class="pr_give_div flex adm-box">
      ...
      <div class="pr_side_menu" style="width: 95%; position: revert; padding: 0 10px 0px 10px;">
        ...
        <div class="pr_side_menu_border" style="height:600px;width: auto;">
          ...
          <div class="search_div">
            <input type="text" class="pr_cate_search adm-input" placeholder="search"/>
    ...
    <div class="pr_give_calendar">
      ...
      <div style="height: 600px; display: flex; flex-direction: column; justify-content: space-between;">
          ...
          <div class="container">
            <div class="my-calendar clearfix">
              <div class="clicked-date" style="display:none;">
                ...
                <div <?php // COMBAK:  ?>lass="cal-date"></div>
              </div>
        ...
        <div class="">
          <div class="flex" style="width:100%; justify-content: space-between; margin-bottom: 1rem;">
            <div class="flex" style="width:50%;display: flex; align-items: center; justify-content: space-between;">
        ...
        <!-- <div class="pr_give_tool">
          <div class="flex" style="width:100%;margin-top:20px;">
