...
<script>
  ...
  $(document).ready(function(){
      $("#user_counseling_popup").hide();
      $("#boss_counseling_popup").hide();

      $("#user_counseling").click(function(){
          $("#user_counseling_popup").show();
      });
    ...
    $(".drop_down_div .question").each(function(){
       ...
       if($(this).data("num") == num){
          ...
          if(!$(this).siblings(".answer").hasClass("on")){
             ...
             $(this).parents(".drop_down_div").css("background", "#d5d5d5");
...
<div id="container">
    ...
    <div class="inner__2" style="text-align: initial; width: 70vw;">
        ...
        <div class="questions">
            ...
            <div class="">
              ...
              <?$i++;}?>
                ...
                <div class="more_btn gray_border" onclick="location.href = '/match/cscenter_sub.php'">
                    자주 묻는 질문 더보기
                </div>
            </div>
        </div>
        ...
        <div class="notice">
            ...
            <div class="gray_border">
              ...
              while($row = sql_fetch_array($n_rs)){?>
                  ...
                  <div class="Q flex">
                      ...
                      <div class="Qright">
                          <?=date("m-d", strtotime(trim($row['reg_date'])) )?>
                      </div>
                  </div>
            ...
            <div class="more_btn gray_border">
                공지사항 더보기
            </div>
        </div>
        ...
        <div class="cscenter">
            ...
            <div class="cscenter_btn_set">
                ...
                <div class="W_half gray_border">
                    <p>대표번호 <span>
                        <a href="tel:070-7576-4460">070-7576-4460</a>
                    </span></p>
                    <span class="icon">
...
<!-- 이용자 상담 팝업 -->
<div class="counseling_popup" id="user_counseling_popup" style="display: none;">
    <div class="top">
        <h3>이용자 상담</h3>
...
<!-- 사장님 상담 팝업 -->
<div class="counseling_popup" id="boss_counseling_popup" style="dispaly: none;">
    <div class="top">
        <h3>사장님 상담</h3>
