...
$sql = "select * from sports_mk_img order by img_order asc";
$p_info_rs = sql_query($sql);


$sql = "select * from sports_mk_img_mobile order by img_order asc";
...
<div class="location">
  <div class="inner__2">
      홈 > 매치업 > 스포츠 마케팅 > <span>매치업 광고</span>
  </div>
...
<div id="container">
  <div class="inner__2">
        ...
        <div class="snb_wrap">
            <div class="fixed">
                <ul class="snb navbar-nav" style="height: 190px;">
                  <li>
                    <div class="snb__logo" style="display: none;">
                        <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                    </div>
                    <a href="javascript:;" data-index="0">매치업 광고</a>
                  </li>
                  <li>
                    <div class="snb__logo" style="display: none;">
                          <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                    </div>
                    <a href="javascript:;" data-index="1">온라인 마케팅</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                      </div>
                    <a href="javascript:;" data-index="2">콘텐츠 제작</a>
                  </li>
