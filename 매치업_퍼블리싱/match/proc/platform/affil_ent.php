...
$uploadBase = G5_PATH."/match/upload_img/affil/";
        ...
        if(in_array($ext,$valid_formats))
        {
            if($size < ( 10*1024*1024 )) // Image size max 1 MB
            {
                ...
                if(move_uploaded_file($tmp, $uploadBase.$actual_image_name))
                {
                  ...
                  $sql = "insert into affiliate_ent(sug_name, phone, facility_name, facility_location, pitches_num, location_type, word, img_name, img_path, img_size, reg_date)
                  ...
                  if($state){
                    $data['rs'] = "success";
                        ...
                        $subject = "제안자 [".$sug_name."] 가맹신청 등록 입니다.";
