...
$sql = "select * from game_match_img order by img_order asc";
$p_info_rs = sql_query($sql);


$sql = "select * from game_match_img_mobile order by img_order asc";
...
$sql = "select * from game_match_banner_img";
...
$sql = "select * from game_match_banner_img_mobile";
$banner = sql_fetch($sql);
            ...
            <div class="fixed">
                <ul class="snb navbar-nav">
                  <li>
                    ...
                    <a href="javascript:;" data-index="0">팀매치</a>
                  </li>
                  <li>
                    <div class="snb__logo" style="display: none;">
                          <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                    </div>
                    <a href="javascript:;" data-index="1">용병매치</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                      </div>
                    <a href="javascript:;" data-index="2">소셜매치</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                      </div>
                    <a href="javascript:;" data-index="3">점령전</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
