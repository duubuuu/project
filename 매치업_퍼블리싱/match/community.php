...
$sql = "select * from community_img order by img_order asc";
$p_info_rs = sql_query($sql);


$sql = "select * from community_img_mobile order by img_order asc";
$m_info_rs = sql_query($sql);

$i=1;


$sql = "select * from community_banner_img";
...
$sql = "select * from community_banner_img_mobile";
$banner = sql_fetch($sql);
            ...
            <div class="fixed">
                <ul class="snb navbar-nav">
                  <li>
                    ...
                    <a href="javascript:;" data-index="0">자유게시판</a>
                  </li>
                  <li>
                    <div class="snb__logo" style="display: none;">
                          <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                    </div>
                    <a href="javascript:;" data-index="1">팀 홍보 게시판</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                      </div>
                    <a href="javascript:;" data-index="2">중고거래</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                      </div>
                    <a href="javascript:;" data-index="3">리그·대회</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
