...
$sql = "select * from team_manager_img order by img_order asc";
$p_info_rs = sql_query($sql);


$sql = "select * from team_manager_img_mobile order by img_order asc";
$m_info_rs = sql_query($sql);

$i=1;


$sql = "select * from team_manager_banner_img";
...
$sql = "select * from team_manager_banner_img_mobile";
$banner = sql_fetch($sql);
...
<div class="location">
  <div class="inner__2">
      홈 > 서비스 > Team manager > <span>팀 생성·검색</span>
  </div>
            ...
            <div class="fixed">
                <ul class="snb navbar-nav">
                  <li>
                    ...
                    <a href="javascript:;" data-index="0">팀 생성·검색</a>
                  </li>
                  <li>
                    <div class="snb__logo" style="display: none;">
                          <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                    </div>
                    <a href="javascript:;" data-index="1">팀원관리</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                      </div>
                    <a href="javascript:;" data-index="2">전술판</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
                      </div>
                    <a href="javascript:;" data-index="3">팀 매치관리</a>
                  </li>
                  <li>
                      <div class="snb__logo" style="display: none;">
                            <img src="img/very-small-logo.png" alt="매우작은매치업로고">
